...
export const PICTURE_IN_PICTURE_ENABLED = { key: "PICTURE_IN_PICTURE_ENABLED", default: true };

export const EXTENDED_VIDEO_PLAYBACK_RATES = [0.25, 0.5, 0.75, 1, 1.10, 1.25, 1.5, 1.75, 2, 2.25, 2.5, 2.75, 3];
